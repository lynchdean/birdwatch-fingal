      ...
      <CardColumns>
        ...
        <Card className="mt-4" bg="dark" text="light">
          ...
          <Card.Body>
            <Card.Text>
              <p>
                We host a series of indoor and outdoor events throughout the
                year. See our Events page for more details. These events are
                open to the public and free of charge with an option to make a
                small donation at the end. We regularly support joint events
                with organisations such Fingal County Council, local schools,
                tidy town groups and other societies, giving talks or walks.
              </p>
            </Card.Text>
          </Card.Body>
        </Card>
          ...
          <Card.Body>
            <Card.Text>
              <p>
                ...
                such as the maintenance of the hides at Rogerstown and running
                the Little Tern and Lapwing projects. Our main fundraiser is the
